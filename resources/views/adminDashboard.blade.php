...
<div class="card-wrapper mt-3 flex h-fit justify-evenly w-[80vw]">
  ...
  <div class="w-[350px] bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
      ...
      <div class="circle text-center">
        <h5 class="mb-2 text-6xl font-bold tracking-tight text-gray-700 dark:text-white">{{ $count[0] }}</h5>
      </div>
      <a href="#"
  ...
  <div class="w-[350px] bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
      ...
      <div class="circle text-center">
        <h5 class="mb-2 text-6xl font-bold tracking-tight text-gray-700 dark:text-white">{{ $count[1] }}</h5>
      </div>
      <a href="#"
        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Read more
  ...
  <div class="w-[350px] bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
      ...
      <div class="circle text-center">
        <h5 class="mb-2 text-3xl font-bold tracking-tight text-gray-700 dark:text-white">Rp. 100.000</h5>
      </div>
      <a href="#"
        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Read more
